...
public:
    ...
    /**
     * @brief Schedule a render (can be overridden by subclasses for deferred rendering)
     * Default implementation calls render() directly
     */
    virtual void scheduleRender() { render(); }
