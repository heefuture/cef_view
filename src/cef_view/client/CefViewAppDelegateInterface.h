...
#pragma region CefApp
    /////////////////////////////////////// CefApp methods: /////////////////////////////////////
    // Called before command line processing. Allows delegate to add custom switches.
    virtual void onBeforeCommandLineProcessing(const CefString& processType,
                                               CefRefPtr<CefCommandLine> commandLine) {}

    // Called to register custom schemes. Delegate should call registrar->AddCustomScheme().
